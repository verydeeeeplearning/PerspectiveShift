...
export class SupabaseFeedbackRepository implements FeedbackRepository {
  ...
  async saveFeedback(feedback: DialogueFeedback): Promise<void> {
    const { error } = await this.client
      ...
      .insert({
        ...
        feel_heard_score: feedback.feelHeardScore,
        affective_warmth: feedback.affectiveWarmth,
  ...
  async findFeedback(
    ...
    return DialogueFeedback.create({
      ...
      feelHeardScore: data.feel_heard_score,
      affectiveWarmth: data.affective_warmth,
